...
<body style="font-family:Arial; max-width:700px; margin:40px auto; padding:20px;">
    ...
    <form method="POST">
        ...
        <textarea
            ...
            placeholder="Example: Futuristic London at night, flying cars above Tower Bridge, cinematic, vertical video"
        ></textarea>
    ...
    if request.method == "POST":
        ...
        if not prompt:
            ...
            try:
                ...
                print("Starting FAL video generation...", flush=True)
                ...
                print("FAL RESULT:", result, flush=True)
                ...
                print("ERROR WHILE GENERATING VIDEO:", flush=True)
                traceback.print_exc()
